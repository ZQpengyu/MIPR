...
train_pw, train_pc, train_qw, train_qc, train_label = read_data('./newdata/lc_train.txt')
dev_pw, dev_pc, dev_qw, dev_qc, dev_label = read_data('./newdata/lc_dev.txt')
test_pw, test_pc, test_qw, test_qc, test_label = read_data('./newdata/lc_test.txt')


train_ppy, train_qpy, train_prad, train_qrad = read_pinyin_radical('./pinyin/lc_train_py.txt', './radical/lc_train_rad.txt')
dev_ppy, dev_qpy, dev_prad, dev_qrad = read_pinyin_radical('./pinyin/lc_dev_py.txt', './radical/lc_dev_rad.txt')
test_ppy, test_qpy, test_prad, test_qrad = read_pinyin_radical('./pinyin/lc_test_py.txt', './radical/lc_test_rad.txt')
